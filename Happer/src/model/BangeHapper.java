 ...
 * @author 09068007
 */
public class BangeHapper extends Happer {

    public BangeHapper(Vak vak, Spel spel){
        super(vak, spel);
    }

    /**
     * Aangepaste versie van de slimmehapper zoekmens
     * Happer kiest hoogste getal ipv laagste
